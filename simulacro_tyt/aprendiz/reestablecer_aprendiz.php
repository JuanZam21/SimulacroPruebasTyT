...
<form action="reestablecer_aprendiz_val.php" method="POST" >
...
<button class=" btn white darken-4 black-text "   type="submit">Reestablecer</button> 
            <a href="login_aprendiz.php"><button class=" btn white darken-4 black-text "  type="button" >Cancelar</button></a>
            </center>
