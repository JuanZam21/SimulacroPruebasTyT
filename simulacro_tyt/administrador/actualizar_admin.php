...
<center><h4 style="color:red">Actualizar mis Datos</h4></center>


<!--     Form add admin                   -->
    <form action="actualizar_admin_val.php" method="POST" class="col s12">
      <div class="row">
	  ...
	  <input name="identificacion_admin" placeholder="<?php echo $_SESSION["di_admin"]?>" id="telephone" type="number" class="validate"  > 
          ...
          <div class="input-field col s6">
          <input name="nombre_admin" id="name" type="text" placeholder="<?php echo $_SESSION['nombre_admin']; 
		?>" class="validate">
        ...
        <div class="input-field col s6">
          <input name="apellido_admin" id="last_name" placeholder="<?php echo $_SESSION["apellido_admin"] ?>" type="text"  class="validate">
         ...
         <div class="input-field col s6">
          <input name="telefono_admin" placeholder="<?php echo $_SESSION["telefono_admin"]; ?>"  id="number" type="number" class="validate">
         <center> <label for="telefono"><center>Numero teléfonico</center></label></center>
        </div>
          
          <div class="input-field col s6">
          <input name="email_admin"  id="email" type="email" placeholder="<?php echo $_SESSION["email_admin"];?>"  class="validate">
       ...
       <div class="row">
        ...
        <div class="input-field col s4">
          <input name="clave_admin" id="password"  minlength="8" type="password" class="validate">
 ...
 <center>   <div class="row">
                <input type="submit" class="btn red " value="ACTUALIZAR MIS DATOS" >
            </div>
 </center>
                </div>
                </form>
