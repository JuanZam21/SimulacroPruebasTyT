...
<center>
<h5>
               <B>Administradores Registrados</B>
...
<td>Correo Electronico</td>
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo $datos ['di_admin'];?></td>
            <td><?php echo $datos ['nombre_admin'];?></td>
            <td><?php echo $datos ['apellido_admin'];?></td>
            <td><?php echo $datos ['telefono_admin'];?></td>
            <td><?php echo $datos ['email_admin'];?></td>
            <td><a href="eliminar_admin.php?id=<?php echo $datos['di_admin'] ?>" class="btn red" ><b>X</b></a> </td>
        </tr>
